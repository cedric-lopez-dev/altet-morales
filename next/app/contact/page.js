            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <div className="space-y-6">
                <div className="flex items-center">
                  <MapPin className="w-6 h-6 text-[#b1976b] mr-4" />
                  <div>
                ...
                <div className="flex items-center">
                  <Phone className="w-6 h-6 text-[#b1976b] mr-4" />
                  <div>
                ...
                <div className="flex items-center">
                  <Mail className="w-6 h-6 text-[#b1976b] mr-4" />
                  <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <input
                    ...
                    required
                    className="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-[#b1976b]"
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full bg-[#b1976b] text-white px-6 py-3 rounded hover:bg-[#a08555] transition-colors duration-200 disabled:opacity-50"
                >
                  {isSubmitting ? 'Envoi en cours...' : 'Envoyer le message'}
                </button>

                {submitStatus.message && (
                  <div className={`text-sm ${submitStatus.type === 'success' ? 'text-[#b1976b]' : 'text-red-600'}`}>
                    {submitStatus.message}
                  </div>
                )}
              </form>
